...
export default function Nav() {
  ...
  return (
    <div className='nav-container  w-100 d-flex justify-content-between align-items-center px-2'>
      <div className='nav-links py-2 d-flex justify-content-between align-items-center gap-2 animate__animated animate__fadeInRight animate__slow	0.3s'>
        <li>
          <Link className='nav-brand fs-3 text-black fw-bold text-white mx-2' to="/">
            <span className='text-danger'>Top</span> Movies
          </Link>
        </li>
        <li>
          <Link className='text-white ml-3' to="/">Home</Link>
        </li>
        <li>
